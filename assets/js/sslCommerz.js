...
!function () {
    ...
    !function (o) {
        ...
        function i(e, t) {
            var n, o, r, i, a, s, l, c, u, d, p, f, m = t && t.split("/"), h = T.map, b = h && h["*"] || {};
            if (e) {
                for (e = e.split("/"), a = e.length - 1, T.nodeIdCompat && x.test(e[a]) && (e[a] = e[a].replace(x, "")), "." === e[0].charAt(0) && m && (f = m.slice(0, m.length - 1), e = f.concat(e)), u = 0; u < e.length; u++) if ("." === (p = e[u])) e.splice(u, 1), u -= 1; else if (".." === p) {
            ...
            if ((m || b) && h) {
                for (n = e.split("/"), u = n.length; u > 0; u -= 1) {
                    if (o = n.slice(0, u).join("/"), m) for (d = m.length; d > 0; d -= 1) if ((r = h[m.slice(0, d).join("/")]) && (r = r[o])) {
                        i = r, s = u;
                        break
                    }
                    if (i) break;
        ...
        var f, m, h, b, g = {}, w = {}, T = {}, y = {}, v = Object.prototype.hasOwnProperty, S = [].slice, x = /\.js$/;
        h = function (e, t) {
            var n, o = u(e), r = o[0], a = t[1];
            return e = o[1], r && (r = i(r, a), n = c(r)), r ? e = n && n.normalize ? n.normalize(e, s(a)) : i(e, a) : (e = i(e, a), o = u(e), r = o[0], e = o[1], r && (n = c(r))), {
                f: r ? r + "!" + e : e,
                n: e,
                pr: r,
                p: n
            ...
            var s, u, p, f, m, T, v, S = [], x = typeof n;
            if (i = i || e, T = d(i), "undefined" === x || "function" === x) {
                for (t = !t.length && n.length ? ["require", "exports", "module"] : t, m = 0; m < t.length; m += 1) if (f = h(t[m], T), "require" === (u = f.f)) S[m] = b.require(e); else if ("exports" === u) S[m] = b.exports(e), v = !0; else if ("module" === u) s = S[m] = b.module(e); else if (r(g, u) || r(w, u) || r(y, u)) S[m] = c(u); else {
            ...
            return t = t || function () {
            }, "function" == typeof n && (n = r, r = i), r ? f(o, e, t, n) : setTimeout(function () {
                f(o, e, t, n)
            }, 4), m
        }, m.config = function (e) {
            return m(e)
        }, e._defined = g, n = function (e, t, n) {
    ...
    o.prototype.validate = function (e, t) {
        ...
        var r, i, a, s, l, c = ["Msxml2.XMLHTTP", "Microsoft.XMLHTTP", "Msxml2.XMLHTTP.4.0"],
            u = /^\s*<\?xml(\s)+version=[\'\"](\d)*.(\d)*[\'\"](\s)*\?>/im, d = /<body[^>]*>\s*([\s\S]+)\s*<\/body>/im,
            p = "undefined" != typeof location && location.href,
            f = p && location.protocol && location.protocol.replace(/\:/, ""), m = p && location.hostname,
            h = p && (location.port || void 0), b = {}, g = e.config && e.config() || {};
        return r = {
            version: "2.0.15", strip: function (e) {
                ...
                var t, n, o, r = !1, i = e.lastIndexOf("."), a = 0 === e.indexOf("./") || 0 === e.indexOf("../");
                return -1 !== i && (!a || i > 1) ? (t = e.substring(0, i), n = e.substring(i + 1)) : t = e, o = n || t, i = o.indexOf("!"), -1 !== i && (r = "strip" === o.substring(i + 1), o = o.substring(0, i), n ? n = o : t = o), {
                    moduleName: t,
                    ext: n,
                    strip: r
                }
            }, xdRegExp: /^((\w+)\:)?\/\/([^\/\\]+)/, useXhr: function (e, t, n, i) {
                var a, s, l, c = r.xdRegExp.exec(e);
                ...
                var i = r.parseName(e), a = i.moduleName + (i.ext ? "." + i.ext : ""), s = t.toUrl(a),
                    l = g.useXhr || r.useXhr;
                if (0 === s.indexOf("empty:")) return void n();
                !p || l(s, f, m, h) ? r.get(s, function (t) {
                ...
                var a = r.parseName(t), s = a.ext ? "." + a.ext : "", l = a.moduleName + s,
                    c = n.toUrl(a.moduleName + s) + ".js";
                r.load(l, n, function (t) {
                    var n = function (e) {
                        return o(c, e)
                    };
        ...
        }, "node" === g.env || !g.env && "undefined" != typeof process && process.versions && process.versions.node && !process.versions["node-webkit"] && !process.versions["atom-shell"] ? (i = t.nodeRequire("fs"), r.get = function (e, t, n) {
            try {
        ...
        }) : "xhr" === g.env || !g.env && r.createXhr() ? r.get = function (e, t, n, o) {
            var i, a = r.createXhr();
            if (a.open("GET", e, !0), o) for (i in o) o.hasOwnProperty(i) && a.setRequestHeader(i.toLowerCase(), o[i]);
            g.onXhr && g.onXhr(a, e), a.onreadystatechange = function (o) {
                var r, i;
        ...
        } : "rhino" === g.env || !g.env && "undefined" != typeof Packages && "undefined" != typeof java ? r.get = function (e, t) {
            var n, o, r = new java.io.File(e), i = java.lang.System.getProperty("line.separator"),
            ...
            t(s)
        } : ("xpconnect" === g.env || !g.env && "undefined" != typeof Components && Components.classes && Components.interfaces) && (a = Components.classes, s = Components.interfaces, Components.utils.import("resource://gre/modules/FileUtils.jsm"), l = "@mozilla.org/windows-registry-key;1" in a, r.get = function (e, t) {
            var n, o, r, i = {};
            l && (e = e.replace(/\//g, "\\")), r = new FileUtils.File(e);
            try {
                n = a["@mozilla.org/network/file-input-stream;1"].createInstance(s.nsIFileInputStream), n.init(r, 1, 0, !1), o = a["@mozilla.org/intl/converter-input-stream;1"].createInstance(s.nsIConverterInputStream), o.init(n, "utf-8", n.available(), s.nsIConverterInputStream.DEFAULT_REPLACEMENT_CHARACTER), o.readString(n.available(), i), o.close(), n.close(), t(i.value)
            } catch (e) {
        ...
        function o(e, t, n) {
            t = t || se;
            var o, r = t.createElement("script");
        ...
        function s(e, t, n) {
            return Te(t) ? Se.grep(e, function (e, o) {
        ...
        function c(e) {
            var t = {};
            return Se.each(e.match(De) || [], function (e, n) {
                t[n] = !0
            }), t
        }
        ...
        function w(e, t, n) {
            var o;
            if (void 0 === n && 1 === e.nodeType) if (o = "data-" + t.replace(_e, "-$&").toLowerCase(), "string" == typeof (n = e.getAttribute(o))) {
                try {
                    n = g(n)
                } catch (e) {
                }
        ...
        function T(e, t, n, o) {
            var r, i, a = 20, s = o ? function () {
                    ...
                    return Se.css(e, t, "")
                }, l = s(), c = n && n[3] || (Se.cssNumber[t] ? "" : "px"),
                u = (Se.cssNumber[t] || "px" !== c && +l) && ze.exec(Se.css(e, t));
            if (u && u[3] !== c) {
                for (l /= 2, c = c || u[3], u = +l || 1; a--;) Se.style(e, t, u + c), (1 - i) * (1 - (i = s() / l || .5)) <= 0 && (a = 0), u /= i;
        ...
        function y(e) {
            var t, n = e.ownerDocument, o = e.nodeName, r = Qe[o];
            return r || (t = n.body.appendChild(n.createElement(o)), r = Se.css(t, "display"), t.parentNode.removeChild(t), "none" === r && (r = "block"), Qe[o] = r, r)
        }

        function v(e, t) {
            for (var n, o, r = [], i = 0, a = e.length; i < a; i++) o = e[i], o.style && (n = o.style.display, t ? ("none" === n && (r[i] = Fe.get(o, "display") || null, r[i] || (o.style.display = "")), "" === o.style.display && Ue(o) && (r[i] = y(o))) : "none" !== n && (r[i] = "none", Fe.set(o, "display", n)));
        ...
        function A(e, t, n, o, i) {
            for (var a, s, l, c, u, d, p = t.createDocumentFragment(), f = [], m = 0, h = e.length; m < h; m++) if ((a = e[m]) || 0 === a) if ("object" === r(a)) Se.merge(f, a.nodeType ? [a] : a); else if (et.test(a)) {
            ...
            for (p.textContent = "", m = 0; a = f[m++];) if (o && Se.inArray(a, o) > -1) i && i.push(a); else if (u = Se.contains(a.ownerDocument, a), s = S(p.appendChild(a), "script"), u && x(s), n) for (d = 0; a = s[d++];) Ze.test(a.type || "") && n.push(a);
            return p
        }
        ...
        function k(e, t, n, o, r, i) {
            ...
            if (null == o && null == r ? (r = n, o = n = void 0) : null == r && ("string" == typeof n ? (r = o, o = void 0) : (r = o, o = n, n = void 0)), !1 === r) r = M; else if (!r) return e;
        ...
        function L(e, t, n, r) {
            t = ue.apply([], t);
            var i, a, s, l, c, u, d = 0, p = e.length, f = p - 1, m = t[0], h = Te(m);
            if (h || p > 1 && "string" == typeof m && !we.checkClone && st.test(m)) return e.each(function (o) {
                var i = e.eq(o);
            ...
            if (p && (i = A(t, e[0].ownerDocument, !1, e, r), a = i.firstChild, 1 === i.childNodes.length && (i = a), a || r)) {
                ...
                if (l) for (u = s[s.length - 1].ownerDocument, Se.map(s, E), d = 0; d < l; d++) c = s[d], Ze.test(c.type || "") && !Fe.access(c, "globalEval") && Se.contains(u, c) && (c.src && "module" !== (c.type || "").toLowerCase() ? Se._evalUrl && Se._evalUrl(c.src) : o(c.textContent.replace(lt, ""), u, c))
            }
            return e
        }
        ...
        function O(e, t, n) {
            ...
            return n = n || ut(e), n && (a = n.getPropertyValue(t) || n[t], "" !== a || Se.contains(e.ownerDocument, e) || (a = Se.style(e, t)), !we.pixelBoxStyles() && ct.test(a) && dt.test(t) && (o = s.width, r = s.minWidth, i = s.maxWidth, s.minWidth = s.maxWidth = s.width = a, a = n.width, s.width = o, s.minWidth = r, s.maxWidth = i)), void 0 !== a ? a + "" : a
        }
        ...
        function X(e, t, n, o, r, i) {
            ...
            for (; a < 4; a += 2) "margin" === n && (l += Se.css(e, n + qe[a], !0, r)), o ? ("content" === n && (l -= Se.css(e, "padding" + qe[a], !0, r)), "margin" !== n && (l -= Se.css(e, "border" + qe[a] + "Width", !0, r))) : (l += Se.css(e, "padding" + qe[a], !0, r), "padding" !== n ? l += Se.css(e, "border" + qe[a] + "Width", !0, r) : s += Se.css(e, "border" + qe[a] + "Width", !0, r));
            return !o && i >= 0 && (l += Math.max(0, Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - i - l - s - .5))), l
        }

        function j(e, t, n) {
            var o = ut(e), r = O(e, t, o), i = "border-box" === Se.css(e, "boxSizing", !1, o), a = i;
            if (ct.test(r)) {
                if (!n) return r;
                r = "auto"
            }
            return a = a && (we.boxSizingReliable() || r === e.style[t]), ("auto" === r || !parseFloat(r) && "inline" === Se.css(e, "display", !1, o)) && (r = e["offset" + t[0].toUpperCase() + t.slice(1)], a = !0), (r = parseFloat(r) || 0) + X(e, t, n || (i ? "border" : "content"), a, o, r) + "px"
        }
        ...
        function K(e, t, n) {
            var o, r, i, a, s, l, c, u, d = "width" in t || "height" in t, p = this, f = {}, m = e.style,
                h = e.nodeType && Ue(e), b = Fe.get(e, "fxshow");
            ...
            if ((l = !Se.isEmptyObject(t)) || !Se.isEmptyObject(f)) {
                d && 1 === e.nodeType && (n.overflow = [m.overflow, m.overflowX, m.overflowY], c = b && b.display, null == c && (c = Fe.get(e, "display")), u = Se.css(e, "display"), "none" === u && (c ? u = c : (v([e], !0), c = e.style.display || c, u = Se.css(e, "display"), v([e]))), ("inline" === u || "inline-block" === u && null != c) && "none" === Se.css(e, "float") && (l || (p.done(function () {
                    m.display = c
                ...
                for (o in f) l || (b ? "hidden" in b && (h = b.hidden) : b = Fe.access(e, "fxshow", {display: c}), i && (b.hidden = !h), h && v([e], !0), p.done(function () {
                    h || v([e]), Fe.remove(e, "fxshow");
                    for (o in f) Se.style(e, o, f[o])
                })), l = U(h ? b[o] : 0, o, p), o in b || (b[o] = l.start, h && (l.end = l.start, l.start = 0))
            }
        }

        function Q(e, t) {
            var n, o, r, i, a;
            for (n in e) if (o = h(n), r = t[o], i = e[n], Array.isArray(i) && (r = i[1], i = e[n] = i[0]), n !== o && (e[o] = i, delete e[n]), (a = Se.cssHooks[o]) && "expand" in a) {
        ...
        function $(e, t, n) {
            var o, r, i = 0, a = $.prefilters.length, s = Se.Deferred().always(function () {
                delete l.elem
            }), l = function () {
                if (r) return !1;
            ...
            return Se.map(u, U, c), Te(c.opts.start) && c.opts.start.call(e, c), c.progress(c.opts.progress).done(c.opts.done, c.opts.complete).fail(c.opts.fail).always(c.opts.always), Se.fx.timer(Se.extend(l, {
                elem: e,
                anim: c,
                queue: c.opts.queue
            })), c
        ...
        function ee(e, t, n, o) {
            ...
            }); else if (n || "object" !== r(t)) o(e, t); else for (i in t) ee(e + "[" + i + "]", t[i], n, o)
        }

        function te(e) {
            return function (t, n) {
                "string" != typeof t && (n = t, t = "*");
                var o, r = 0, i = t.toLowerCase().match(De) || [];
        ...
        function ne(e, t, n, o) {
            function r(s) {
                var l;
                return i[s] = !0, Se.each(e[s] || [], function (e, s) {
                    var c = s(t, n, o);
        ...
        function oe(e, t) {
            var n, o, r = Se.ajaxSettings.flatOptions || {};
        ...
        function ie(e, t, n, o) {
            ...
            for (i = u.shift(); i;) if (e.responseFields[i] && (n[e.responseFields[i]] = t), !l && o && e.dataFilter && (t = e.dataFilter(t, e.dataType)), l = i, i = u.shift()) if ("*" === i) i = l; else if ("*" !== l && l !== i) {
                if (!(a = c[l + " " + i] || c["* " + i])) for (r in c) if (s = r.split(" "), s[1] === i && (a = c[l + " " + s[0]] || c["* " + s[0]])) {
        ...
        var ae = [], se = e.document, le = Object.getPrototypeOf, ce = ae.slice, ue = ae.concat, de = ae.push,
            pe = ae.indexOf, fe = {}, me = fe.toString, he = fe.hasOwnProperty, be = he.toString, ge = be.call(Object),
            we = {}, Te = function (e) {
                return "function" == typeof e && "number" != typeof e.nodeType
            }, ye = function (e) {
                return null != e && e === e.window
            }, ve = {type: !0, src: !0, noModule: !0}, Se = function (e, t) {
                return new Se.fn.init(e, t)
            }, xe = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g;
        Se.fn = Se.prototype = {
            jquery: "3.3.1", constructor: Se, length: 0, toArray: function () {
                return ce.call(this)
            }, get: function (e) {
            ...
            }, push: de, sort: ae.sort, splice: ae.splice
        }, Se.extend = Se.fn.extend = function () {
            var e, t, n, o, r, i, a = arguments[0] || {}, s = 1, l = arguments.length, c = !1;
            for ("boolean" == typeof a && (c = a, a = arguments[s] || {}, s++), "object" == typeof a || Te(a) || (a = {}), s === l && (a = this, s--); s < l; s++) if (null != (e = arguments[s])) for (t in e) n = a[t], o = e[t], a !== o && (c && o && (Se.isPlainObject(o) || (r = Array.isArray(o))) ? (r ? (r = !1, i = n && Array.isArray(n) ? n : []) : i = n && Se.isPlainObject(n) ? n : {}, a[t] = Se.extend(c, i, o)) : void 0 !== o && (a[t] = o));
            return a
        }, Se.extend({
        ...
        var Ae = function (e) {
            function t(e, t, n, o) {
                var r, i, a, s, l, u, p, f = t && t.ownerDocument, m = t ? t.nodeType : 9;
                if (n = n || [], "string" != typeof e || !e || 1 !== m && 9 !== m && 11 !== m) return n;
                if (!o && ((t ? t.ownerDocument || t : V) !== E && B(t), t = t || E, D)) {
                    if (11 !== m && (l = he.exec(e))) if (r = l[1]) {
                        if (9 === m) {
            ...
            function p(e, t, n) {
                var o = t.dir, r = t.next, i = r || o, a = n && "parentNode" === i, s = X++;
                return t.first ? function (t, n, r) {
                    ...
                    } else for (; t = t[o];) if (1 === t.nodeType || a) if (d = t[R] || (t[R] = {}), u = d[t.uniqueID] || (d[t.uniqueID] = {}), r && r === t.nodeName.toLowerCase()) t = t[o] || t; else {
            ...
            function b(e, t, n, r, i, a) {
                return r && !r[R] && (r = b(r)), i && !i[R] && (i = b(i, a)), o(function (o, a, s, l) {
                    var c, u, d, p = [], f = [], b = a.length, g = o || m(t || "*", s.nodeType ? [s] : s, []),
                        w = !e || !o && t ? g : h(g, p, e, s, l), T = n ? i || (o ? e : b || r) ? [] : a : w;
            ...
            function g(e) {
                for (var t, n, o, r = e.length, i = v.relative[e[0].type], a = i || v.relative[" "], s = i ? 1 : 0, l = p(function (e) {
                    return e === t
                }, a, !0), c = p(function (e) {
                    return Z(t, e) > -1
                    ...
                    return t = null, r
                }]; s < r; s++) if (n = v.relative[e[s].type]) u = [p(f(u), n)]; else {
            ...
            function w(e, n) {
                var r = n.length > 0, i = e.length > 0, a = function (o, a, s, l, c) {
                    var u, d, p, f = 0, m = "0", b = o && [], g = [], w = C, T = o || i && v.find.TAG("*", c),
                        y = F += null == w ? 1 : Math.random() || .1, S = T.length;
                    for (c && (C = a === E || a || c); m !== S && null != (u = T[m]); m++) {
                        if (i && u) {
                            for (d = 0, a || u.ownerDocument === E || (B(u), s = !D); p = e[d++];) if (p(u, a || E, s)) {
                                l.push(u);
                                break
                            }
                            c && (F = y)
            ...
            var T, y, v, S, x, A, P, M, C, k, G, B, E, H, D, L, I, O, N, R = "sizzle" + 1 * new Date, V = e.document,
                F = 0, X = 0, j = n(), _ = n(), W = n(), z = function (e, t) {
                    return e === t && (G = !0), 0
                }, q = {}.hasOwnProperty, U = [], K = U.pop, Q = U.push, $ = U.push, Y = U.slice, Z = function (e, t) {
                ...
                le = new RegExp("=" + ee + "*([^\\]'\"]*?)" + ee + "*\\]", "g"), ce = new RegExp(oe),
                ue = new RegExp("^" + te + "$"), de = {
                    ID: new RegExp("^#(" + te + ")"),
                    CLASS: new RegExp("^\\.(" + te + ")"),
                    TAG: new RegExp("^(" + te + "|[*])"),
                ...
                }, pe = /^(?:input|select|textarea|button)$/i, fe = /^h\d$/i, me = /^[^{]+\{\s*\[native \w/,
                he = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, be = /[+~]/,
                ge = new RegExp("\\\\([\\da-f]{1,6}" + ee + "?|(" + ee + ")|.)", "ig"), we = function (e, t, n) {
                    var o = "0x" + t - 65536;
                    return o !== o || n ? t : o < 0 ? String.fromCharCode(o + 65536) : String.fromCharCode(o >> 10 | 55296, 1023 & o | 56320)
                }, Te = /([\0-\x1f\x7f]|^-?\d)|^-$|[^\0-\x1f\x7f-\uFFFF\w-]/g, ye = function (e, t) {
            ...
            y = t.support = {}, x = t.isXML = function (e) {
                ...
                return o !== E && 9 === o.nodeType && o.documentElement ? (E = o, H = E.documentElement, D = !x(E), V !== E && (n = E.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", ve, !1) : n.attachEvent && n.attachEvent("onunload", ve)), y.attributes = r(function (e) {
                    return e.className = "i", !e.getAttribute("className")
                }), y.getElementsByTagName = r(function (e) {
                    return e.appendChild(E.createComment("")), !e.getElementsByTagName("*").length
                }), y.getElementsByClassName = me.test(E.getElementsByClassName), y.getById = r(function (e) {
                    return H.appendChild(e).id = R, !E.getElementsByName || !E.getElementsByName(R).length
                }), y.getById ? (v.filter.ID = function (e) {
                ...
                }), v.find.TAG = y.getElementsByTagName ? function (e, t) {
                    ...
                    return i
                }, v.find.CLASS = y.getElementsByClassName && function (e, t) {
                    if (void 0 !== t.getElementsByClassName && D) return t.getElementsByClassName(e)
                }, I = [], L = [], (y.qsa = me.test(E.querySelectorAll)) && (r(function (e) {
                    ...
                    t.setAttribute("type", "hidden"), e.appendChild(t).setAttribute("name", "D"), e.querySelectorAll("[name=d]").length && L.push("name" + ee + "*[*^$|!~]?="), 2 !== e.querySelectorAll(":enabled").length && L.push(":enabled", ":disabled"), H.appendChild(e).disabled = !0, 2 !== e.querySelectorAll(":disabled").length && L.push(":enabled", ":disabled"), e.querySelectorAll("*,:x"), L.push(",.*:")
                })), (y.matchesSelector = me.test(O = H.matches || H.webkitMatchesSelector || H.mozMatchesSelector || H.oMatchesSelector || H.msMatchesSelector)) && r(function (e) {
                    y.disconnectedMatch = O.call(e, "*"), O.call(e, "[s!='']:x"), I.push("!=", oe)
                }), L = L.length && new RegExp(L.join("|")), I = I.length && new RegExp(I.join("|")), t = me.test(H.compareDocumentPosition), N = t || me.test(H.contains) ? function (e, t) {
                    ...
                    return n || (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1, 1 & n || !y.sortDetached && t.compareDocumentPosition(e) === n ? e === E || e.ownerDocument === V && N(V, e) ? -1 : t === E || t.ownerDocument === V && N(V, t) ? 1 : k ? Z(k, e) - Z(k, t) : 0 : 4 & n ? -1 : 1)
                } : function (e, t) {
                    if (e === t) return G = !0, 0;
                    var n, o = 0, r = e.parentNode, i = t.parentNode, s = [e], l = [t];
                ...
                if ((e.ownerDocument || e) !== E && B(e), n = n.replace(le, "='$1']"), y.matchesSelector && D && !W[n + " "] && (!I || !I.test(n)) && (!L || !L.test(n))) try {
                    var o = O.call(e, n);
                ...
                filter: {
                    TAG: function (e) {
                        ...
                        return 1 === o && 0 === r ? function (e) {
                            ...
                            var c, u, d, p, f, m, h = i !== a ? "nextSibling" : "previousSibling", b = t.parentNode,
                                g = s && t.nodeName.toLowerCase(), w = !l && !s, T = !1;
                            if (b) {
                                if (i) {
                                    for (; h;) {
                                ...
                                if (m = [a ? b.firstChild : b.lastChild], a && w) {
                                    for (p = b, d = p[R] || (p[R] = {}), u = d[p.uniqueID] || (d[p.uniqueID] = {}), c = u[e] || [], f = c[0] === F && c[1], T = f && c[2], p = f && b.childNodes[f]; p = ++f && p && p[h] || (T = f = 0) || m.pop();) if (1 === p.nodeType && ++T && p === t) {
                                        u[e] = [F, f, T];
                                        break
                                    }
                                } else if (w && (p = t, d = p[R] || (p[R] = {}), u = d[p.uniqueID] || (d[p.uniqueID] = {}), c = u[e] || [], f = c[0] === F && c[1], T = f), !1 === T) for (; (p = ++f && p && p[h] || (T = f = 0) || m.pop()) && ((s ? p.nodeName.toLowerCase() !== g : 1 !== p.nodeType) || !++T || (w && (d = p[R] || (p[R] = {}), u = d[p.uniqueID] || (d[p.uniqueID] = {}), u[e] = [F, T]), p !== t));) ;
                                return (T -= r) === o || T % o == 0 && T / o >= 0
                            }
                        }
                    }, PSEUDO: function (e, n) {
                        var r, i = v.pseudos[e] || v.setFilters[e.toLowerCase()] || t.error("unsupported pseudo: " + e);
                        return i[R] ? i(n) : i.length > 1 ? (r = [e, e, "", n], v.setFilters.hasOwnProperty(e.toLowerCase()) ? o(function (e, t) {
                ...
                pseudos: {
                    not: o(function (e) {
                        ...
                        return e = e.replace(ge, we), function (t) {
                            return (t.textContent || t.innerText || S(t)).indexOf(e) > -1
                        }
                    }), lang: o(function (e) {
                        return ue.test(e || "") || t.error("unsupported lang: " + e), e = e.replace(ge, we).toLowerCase(), function (t) {
                            var n;
                            do {
            ...
            for (T in {radio: !0, checkbox: !0, file: !0, password: !0, image: !0}) v.pseudos[T] = function (e) {
                return function (t) {
                    return "input" === t.nodeName.toLowerCase() && t.type === e
                }
            }(T);
            for (T in {submit: !0, reset: !0}) v.pseudos[T] = function (e) {
                return function (t) {
                    var n = t.nodeName.toLowerCase();
                    return ("input" === n || "button" === n) && t.type === e
                }
            }(T);
            return u.prototype = v.filters = v.pseudos, v.setFilters = new u, A = t.tokenize = function (e, n) {
                ...
                for (s = e, l = [], c = v.preFilter; s;) {
                    ...
                    for (a in v.filter) !(r = de[a].exec(s)) || c[a] && !(r = c[a](r)) || (o = r.shift(), i.push({
                        value: o,
                        type: a,
                        matches: r
                    }), s = s.slice(o.length));
                ...
                var r, i, a, s, l, u = "function" == typeof e && e, p = !o && A(e = u.selector || e);
                if (n = n || [], 1 === p.length) {
                    ...
                    for (r = de.needsContext.test(e) ? 0 : i.length; r-- && (a = i[r], !v.relative[s = a.type]);) if ((l = v.find[s]) && (o = l(a.matches[0].replace(ge, we), be.test(i[0].type) && c(t.parentNode) || t))) {
                        if (i.splice(r, 1), !(e = o.length && d(i))) return $.apply(n, o), n;
                        break
                    }
                }
                return (u || P(e, p))(o, t, !D, n, !t || be.test(e) && c(t.parentNode) || t), n
            }, y.sortStable = R.split("").sort(z).join("") === R, y.detectDuplicates = !!G, B(), y.sortDetached = r(function (e) {
        ...
        Se.find = Ae, Se.expr = Ae.selectors, Se.expr[":"] = Se.expr.pseudos, Se.uniqueSort = Se.unique = Ae.uniqueSort, Se.text = Ae.getText, Se.isXMLDoc = Ae.isXML, Se.contains = Ae.contains, Se.escapeSelector = Ae.escape;
        var Pe = function (e, t, n) {
            ...
            return n
        }, Ce = Se.expr.match.needsContext, ke = /^<([a-z][^\/\0>:\x20\t\r\n\f]*)[\x20\t\r\n\f]*\/?>(?:<\/\1>|)$/i;
        ...
        (Se.fn.init = function (e, t, n) {
            ...
            if (n = n || Ge, "string" == typeof e) {
                ...
                if (o[1]) {
                    if (t = t instanceof Se ? t[0] : t, Se.merge(this, Se.parseHTML(o[1], t && t.nodeType ? t.ownerDocument || t : se, !0)), ke.test(o[1]) && Se.isPlainObject(t)) for (o in t) Te(this[o]) ? this[o](t[o]) : this.attr(o, t[o]);
                    return this
                }
        ...
        }).prototype = Se.fn, Ge = Se(se);
        var Ee = /^(?:parents|prev(?:Until|All))/, He = {children: !0, contents: !0, next: !0, prev: !0};
        Se.fn.extend({
            has: function (e) {
                ...
                var n, o = 0, r = this.length, i = [], a = "string" != typeof e && Se(e);
                if (!Ce.test(e)) for (; o < r; o++) for (n = this[o]; n && n !== t; n = n.parentNode) if (n.nodeType < 11 && (a ? a.index(n) > -1 : 1 === n.nodeType && Se.find.matchesSelector(n, e))) {
                    i.push(n);
                    break
                }
        ...
        Se.Callbacks = function (e) {
            ...
            var t, n, o, i, a = [], s = [], l = -1, u = function () {
            ...
            Deferred: function (t) {
                                ...
                                return function () {
                                    var s = this, l = arguments, c = function () {
                                        ...
                                        if (!(t < a)) {
                                            ...
                                            c = e && ("object" == typeof e || "function" == typeof e) && e.then, Te(c) ? r ? c.call(e, i(a, n, u, r), i(a, n, d, r)) : (a++, c.call(e, i(a, n, u, r), i(a, n, d, r), i(a, n, u, n.notifyWith))) : (o !== u && (s = void 0, l = [e]), (r || n.resolveWith)(s, l))
                                        }
                                    }, p = r ? c : function () {
                                        try {
                                            c()
                ...
                var t = arguments.length, n = t, o = Array(n), r = ce.call(arguments), i = Se.Deferred(),
                    a = function (e) {
                        return function (n) {
        ...
        }), Se.ready.then = Ie.then, "complete" === se.readyState || "loading" !== se.readyState && !se.documentElement.doScroll ? e.setTimeout(Se.ready) : (se.addEventListener("DOMContentLoaded", f), e.addEventListener("load", f));
        var Oe = function (e, t, n, o, i, a, s) {
            var l = 0, c = e.length, u = null == n;
            if ("object" === r(n)) {
                i = !0;
                for (l in n) Oe(e, t, l, n[l], !0, a, s)
            } else if (void 0 !== o && (i = !0, Te(o) || (s = !0), u && (s ? (t.call(e, o), t = null) : (u = t, t = function (e, t, n) {
                return u.call(Se(e), n)
            })), t)) for (; l < c; l++) t(e[l], n, s ? o : o.call(e[l], l, t(e[l], n)));
            return i ? e : u ? t.call(e) : c ? t(e[0], n) : a
        }, Ne = /^-ms-/, Re = /-([a-z])/g, Ve = function (e) {
        ...
        b.uid = 1, b.prototype = {
            cache: function (e) {
                ...
                if ("string" == typeof t) r[h(t)] = n; else for (o in t) r[h(o)] = t[o];
                return r
            }, get: function (e, t) {
        ...
        var Fe = new b, Xe = new b, je = /^(?:\{[\w\W]*\}|\[[\w\W]*\])$/, _e = /[A-Z]/g;
        Se.extend({
            hasData: function (e) {
            ...
            queue: function (e, t, n) {
                ...
                t = t || "fx";
                var n = Se.queue(e, t), o = n.length, r = n.shift(), i = Se._queueHooks(e, t), a = function () {
                    Se.dequeue(e, t)
                };
            ...
            queue: function (e, t) {
                ...
                var n, o = 1, r = Se.Deferred(), i = this, a = this.length, s = function () {
                    --o || r.resolveWith(i, [i])
                };
        ...
        var $e = /^(?:checkbox|radio)$/i, Ye = /<([a-z][^\/\0>\x20\t\r\n\f]+)/i,
            Ze = /^$|^module$|\/(?:java|ecma)script/i, Je = {
        ...
        var tt = se.documentElement, nt = /^key/, ot = /^(?:mouse|pointer|contextmenu|drag|drop)|click/,
            rt = /^([^.]*)(?:\.(.+)|)/;
        Se.event = {
            global: {}, add: function (e, t, n, o, r) {
                var i, a, s, l, c, u, d, p, f, m, h, b = Fe.get(e);
                if (b) for (n.handler && (i = n, n = i.handler, r = i.selector), r && Se.find.matchesSelector(tt, r), n.guid || (n.guid = Se.guid++), (l = b.events) || (l = b.events = {}), (a = b.handle) || (a = b.handle = function (t) {
                    return void 0 !== Se && Se.event.triggered !== t.type ? Se.event.dispatch.apply(e, arguments) : void 0
                }), t = (t || "").match(De) || [""], c = t.length; c--;) s = rt.exec(t[c]) || [], f = h = s[1], m = (s[2] || "").split(".").sort(), f && (d = Se.event.special[f] || {}, f = (r ? d.delegateType : d.bindType) || f, d = Se.event.special[f] || {}, u = Se.extend({
                    type: f,
                    origType: h,
                    data: o,
                    handler: n,
                    ...
                    namespace: m.join(".")
                }, i), (p = l[f]) || (p = l[f] = [], p.delegateCount = 0, d.setup && !1 !== d.setup.call(e, o, m, a) || e.addEventListener && e.addEventListener(f, a)), d.add && (d.add.call(e, u), u.handler.guid || (u.handler.guid = n.guid)), r ? p.splice(p.delegateCount++, 0, u) : p.push(u), Se.event.global[f] = !0)
            }, remove: function (e, t, n, o, r) {
                var i, a, s, l, c, u, d, p, f, m, h, b = Fe.hasData(e) && Fe.get(e);
                if (b && (l = b.events)) {
                    for (t = (t || "").match(De) || [""], c = t.length; c--;) if (s = rt.exec(t[c]) || [], f = h = s[1], m = (s[2] || "").split(".").sort(), f) {
                        for (d = Se.event.special[f] || {}, f = (o ? d.delegateType : d.bindType) || f, p = l[f] || [], s = s[2] && new RegExp("(^|\\.)" + m.join("\\.(?:.*\\.|)") + "(\\.|$)"), a = i = p.length; i--;) u = p[i], !r && h !== u.origType || n && n.guid !== u.guid || s && !s.test(u.namespace) || o && o !== u.selector && ("**" !== o || !u.selector) || (p.splice(i, 1), u.selector && p.delegateCount--, d.remove && d.remove.call(e, u));
                ...
                var t, n, o, r, i, a, s = Se.event.fix(e), l = new Array(arguments.length),
                    c = (Fe.get(this, "events") || {})[s.type] || [], u = Se.event.special[s.type] || {};
            ...
            e && e.type ? (this.originalEvent = e, this.type = e.type, this.isDefaultPrevented = e.defaultPrevented || void 0 === e.defaultPrevented && !1 === e.returnValue ? P : M, this.target = e.target && 3 === e.target.nodeType ? e.target.parentNode : e.target, this.currentTarget = e.currentTarget, this.relatedTarget = e.relatedTarget) : this.type = e, t && Se.extend(this, t), this.timeStamp = e && e.timeStamp || Date.now(), this[Se.expando] = !0
        }, Se.Event.prototype = {
        ...
        var it = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([a-z][^\/\0>\x20\t\r\n\f]*)[^>]*)\/>/gi,
            at = /<script|<style|<link/i, st = /checked\s*(?:[^=]|=\s*.checked.)/i,
            lt = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g;
        Se.extend({
            htmlPrefilter: function (e) {
                return e.replace(it, "<$1></$2>")
            }, clone: function (e, t, n) {
                var o, r, i, a, s = e.cloneNode(!0), l = Se.contains(e.ownerDocument, e);
                if (!(we.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || Se.isXMLDoc(e))) for (a = S(s), i = S(e), o = 0, r = i.length; o < r; o++) D(i[o], a[o]);
                if (t) if (n) for (i = i || S(e), a = a || S(s), o = 0, r = i.length; o < r; o++) H(i[o], a[o]); else H(e, s);
                return a = S(s, "script"), a.length > 0 && x(a, !l && S(e, "script")), s
            }, cleanData: function (e) {
                for (var t, n, o, r = Se.event.special, i = 0; void 0 !== (n = e[i]); i++) if (Ve(n)) {
                    if (t = n[Fe.expando]) {
        ...
        var ct = new RegExp("^(" + We + ")(?!px)[a-z%]+$", "i"), ut = function (t) {
        ...
        !function () {
            function t() {
                if (c) {
                    ...
                    o = "1%" !== t.top, s = 12 === n(t.marginLeft), c.style.right = "60%", a = 36 === n(t.right), r = 36 === n(t.width), c.style.position = "absolute", i = 36 === c.offsetWidth || "absolute", tt.removeChild(l), c = null
                }
            }
            ...
            var o, r, i, a, s, l = se.createElement("div"), c = se.createElement("div");
        ...
        var pt = /^(none|table(?!-c[ea]).+)/, ft = /^--/,
            mt = {position: "absolute", visibility: "hidden", display: "block"},
            ht = {letterSpacing: "0", fontWeight: "400"}, bt = ["Webkit", "Moz", "ms"],
        ...
        Se.extend({
            ...
            style: function (e, t, n, o) {
                if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                    var r, i, a, s = h(t), l = ft.test(t), c = e.style;
                    if (l || (t = V(s)), a = Se.cssHooks[t] || Se.cssHooks[s], void 0 === n) return a && "get" in a && void 0 !== (r = a.get(e, !1, o)) ? r : c[t];
                    i = typeof n, "string" === i && (r = ze.exec(n)) && r[1] && (n = T(e, t, r), i = "number"), null != n && n === n && ("number" === i && (n += r && r[3] || (Se.cssNumber[s] ? "" : "px")), we.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (c[t] = "inherit"), a && "set" in a && void 0 === (n = a.set(e, n, o)) || (l ? c.setProperty(t, n) : c[t] = n))
                }
            },
            css: function (e, t, n, o) {
                var r, i, a, s = h(t);
                return ft.test(t) || (t = V(s)), a = Se.cssHooks[t] || Se.cssHooks[s], a && "get" in a && (r = a.get(e, !0, n)), void 0 === r && (r = O(e, t, o)), "normal" === r && t in ht && (r = ht[t]), "" === n || n ? (i = parseFloat(r), !0 === n || isFinite(i) ? i || 0 : r) : r
            }
        }), Se.each(["height", "width"], function (e, t) {
            Se.cssHooks[t] = {
                get: function (e, n, o) {
                    if (n) return !pt.test(Se.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? j(e, t, o) : Ke(e, mt, function () {
                        return j(e, t, o)
                    })
                }, set: function (e, n, o) {
                    var r, i = ut(e), a = "border-box" === Se.css(e, "boxSizing", !1, i), s = o && X(e, t, o, a, i);
                    return a && we.scrollboxSize() === i.position && (s -= Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - parseFloat(i[t]) - X(e, t, "border", !1, i) - .5)), s && (r = ze.exec(n)) && "px" !== (r[3] || "px") && (e.style[t] = n, n = Se.css(e, t)), F(e, n, s)
                }
            }
        }), Se.cssHooks.marginLeft = N(we.reliableMarginLeft, function (e, t) {
            if (t) return (parseFloat(O(e, "marginLeft")) || e.getBoundingClientRect().left - Ke(e, {marginLeft: 0}, function () {
            ...
            constructor: _, init: function (e, t, n, o, r, i) {
        ...
        var wt, Tt, yt = /^(?:toggle|show|hide)$/, vt = /queueHooks$/;
        Se.Animation = Se.extend($, {
            ...
            return Se.fx.off ? o.duration = 0 : "number" != typeof o.duration && (o.duration in Se.fx.speeds ? o.duration = Se.fx.speeds[o.duration] : o.duration = Se.fx.speeds._default), null != o.queue && !0 !== o.queue || (o.queue = "fx"), o.old = o.complete, o.complete = function () {
            ...
            fadeTo: function (e, t, n, o) {
                ...
                var r = Se.isEmptyObject(e), i = Se.speed(t, n, o), a = function () {
                ...
                return "string" != typeof e && (n = t, t = e, e = void 0), t && !1 !== e && this.queue(e || "fx", []), this.each(function () {
                    var t = !0, r = null != e && e + "queueHooks", i = Se.timers, a = Fe.get(this);
                    if (r) a[r] && a[r].stop && o(a[r]); else for (r in a) a[r] && a[r].stop && vt.test(r) && o(a[r]);
                    for (r = i.length; r--;) i[r].elem !== this || null != e && i[r].queue !== e || (i[r].anim.stop(n), t = !1, i.splice(r, 1));
                    !t && n || Se.dequeue(this, e)
                })
            }, finish: function (e) {
                return !1 !== e && (e = e || "fx"), this.each(function () {
                    var t, n = Fe.get(this), o = n[e + "queue"], r = n[e + "queueHooks"], i = Se.timers,
                        a = o ? o.length : 0;
        ...
        Se.fn.extend({
            ...
            attr: function (e, t, n) {
                ...
                if (3 !== i && 8 !== i && 2 !== i) return void 0 === e.getAttribute ? Se.prop(e, t, n) : (1 === i && Se.isXMLDoc(e) || (r = Se.attrHooks[t.toLowerCase()] || (Se.expr.match.bool.test(t) ? St : void 0)), void 0 !== n ? null === n ? void Se.removeAttr(e, t) : r && "set" in r && void 0 !== (o = r.set(e, n, t)) ? o : (e.setAttribute(t, n + ""), n) : r && "get" in r && null !== (o = r.get(e, t)) ? o : (o = Se.find.attr(e, t), null == o ? void 0 : o))
            }, attrHooks: {
                type: {
                    set: function (e, t) {
        ...
        var At = /^(?:input|select|textarea|button)$/i, Pt = /^(?:a|area)$/i;
        Se.fn.extend({
            prop: function (e, t) {
            ...
            prop: function (e, t, n) {
                var o, r, i = e.nodeType;
                if (3 !== i && 8 !== i && 2 !== i) return 1 === i && Se.isXMLDoc(e) || (t = Se.propFix[t] || t, r = Se.propHooks[t]), void 0 !== n ? r && "set" in r && void 0 !== (o = r.set(e, n, t)) ? o : e[t] = n : r && "get" in r && null !== (o = r.get(e, t)) ? o : e[t]
            }, propHooks: {
                tabIndex: {
                    get: function (e) {
            ...
            addClass: function (e) {
                ...
                if (t = J(e), t.length) for (; n = this[l++];) if (r = Z(n), o = 1 === n.nodeType && " " + Y(r) + " ") {
                ...
                return "boolean" == typeof t && o ? t ? this.addClass(e) : this.removeClass(e) : Te(e) ? this.each(function (n) {
                    Se(this).toggleClass(e.call(this, n, Z(this), t), t)
                }) : this.each(function () {
                    var t, r, i, a;
                    if (o) for (r = 0, i = Se(this), a = J(e); t = a[r++];) i.hasClass(t) ? i.removeClass(t) : i.addClass(t); else void 0 !== e && "boolean" !== n || (t = Z(this), t && Fe.set(this, "__className__", t), this.setAttribute && this.setAttribute("class", t || !1 === e ? "" : Fe.get(this, "__className__") || ""))
                })
            }, hasClass: function (e) {
                var t, n, o = 0;
        ...
        Se.fn.extend({
            val: function (e) {
                var t, n, o, r = this[0];
                {
                    if (arguments.length) return o = Te(e), this.each(function (n) {
                        var r;
                        1 === this.nodeType && (r = o ? e.call(this, n, Se(this).val()) : e, null == r ? r = "" : "number" == typeof r ? r += "" : Array.isArray(r) && (r = Se.map(r, function (e) {
                            return null == e ? "" : e + ""
                        })), (t = Se.valHooks[this.type] || Se.valHooks[this.nodeName.toLowerCase()]) && "set" in t && void 0 !== t.set(this, r, "value") || (this.value = r))
                    });
                    if (r) return (t = Se.valHooks[r.type] || Se.valHooks[r.nodeName.toLowerCase()]) && "get" in t && void 0 !== (n = t.get(r, "value")) ? n : (n = r.value, "string" == typeof n ? n.replace(Mt, "") : null == n ? "" : n)
                }
            }
        }), Se.extend({
            valHooks: {
                option: {
                    ...
                    get: function (e) {
                        var t, n, o, r = e.options, i = e.selectedIndex, s = "select-one" === e.type, l = s ? null : [],
                            c = s ? i + 1 : r.length;
                        for (o = i < 0 ? c : s ? i : 0; o < c; o++) if (n = r[o], (n.selected || o === i) && !n.disabled && (!n.parentNode.disabled || !a(n.parentNode, "optgroup"))) {
        ...
        Se.extend(Se.event, {
            trigger: function (t, n, o, r) {
                var i, a, s, l, c, u, d, p, f = [o || se], m = he.call(t, "type") ? t.type : t,
                    h = he.call(t, "namespace") ? t.namespace.split(".") : [];
                if (a = p = s = o = o || se, 3 !== o.nodeType && 8 !== o.nodeType && !Ct.test(m + Se.event.triggered) && (m.indexOf(".") > -1 && (h = m.split("."), m = h.shift(), h.sort()), c = m.indexOf(":") < 0 && "on" + m, t = t[Se.expando] ? t : new Se.Event(m, "object" == typeof t && t), t.isTrigger = r ? 2 : 3, t.namespace = h.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = o), n = null == n ? [t] : Se.makeArray(n, [t]), d = Se.event.special[m] || {}, r || !d.trigger || !1 !== d.trigger.apply(o, n))) {
                    ...
                    for (i = 0; (a = f[i++]) && !t.isPropagationStopped();) p = a, t.type = i > 1 ? l : d.bindType || m, u = (Fe.get(a, "events") || {})[t.type] && Fe.get(a, "handle"), u && u.apply(a, n), (u = c && a[c]) && u.apply && Ve(a) && (t.result = u.apply(a, n), !1 === t.result && t.preventDefault());
                    return t.type = m, r || t.isDefaultPrevented() || d._default && !1 !== d._default.apply(f.pop(), n) || !Ve(o) || c && Te(o[m]) && !ye(o) && (s = o[c], s && (o[c] = null), Se.event.triggered = m, t.isPropagationStopped() && p.addEventListener(m, kt), o[m](), t.isPropagationStopped() && p.removeEventListener(m, kt), Se.event.triggered = void 0, s && (o[c] = s)), t.result
                }
        ...
        }), we.focusin || Se.each({focus: "focusin", blur: "focusout"}, function (e, t) {
            var n = function (e) {
                Se.event.simulate(t, e.target, Se.event.fix(e))
            };
            Se.event.special[t] = {
                setup: function () {
                    var o = this.ownerDocument || this, r = Fe.access(o, t);
                    r || o.addEventListener(e, n, !0), Fe.access(o, t, (r || 0) + 1)
                }, teardown: function () {
                    var o = this.ownerDocument || this, r = Fe.access(o, t) - 1;
                    r ? Fe.access(o, t, r) : (o.removeEventListener(e, n, !0), Fe.remove(o, t))
                }
            }
        });
        var Gt = e.location, Bt = Date.now(), Et = /\?/;
        ...
        var Ot = /%20/g, Nt = /#.*$/, Rt = /([?&])_=[^&]*/, Vt = /^(.*?):[ \t]*([^\r\n]*)$/gm,
            Ft = /^(?:about|app|app-storage|.+-extension|file|res|widget):$/, Xt = /^(?:GET|HEAD)$/, jt = /^\/\//,
            _t = {}, Wt = {}, zt = "*/".concat("*"), qt = se.createElement("a");
        qt.href = Gt.href, Se.extend({
            active: 0,
            lastModified: {},
            etag: {},
            ajaxSettings: {
            ...
            ajax: function (t, n) {
                function o(t, n, o, s) {
                    var c, p, f, y, v, S = n;
                    u || (u = !0, l && e.clearTimeout(l), r = void 0, a = s || "", x.readyState = t > 0 ? 4 : 0, c = t >= 200 && t < 300 || 304 === t, o && (y = re(m, x, o)), y = ie(m, y, x, c), c ? (m.ifModified && (v = x.getResponseHeader("Last-Modified"), v && (Se.lastModified[i] = v), (v = x.getResponseHeader("etag")) && (Se.etag[i] = v)), 204 === t || "HEAD" === m.type ? S = "nocontent" : 304 === t ? S = "notmodified" : (S = y.state, p = y.data, f = y.error, c = !f)) : (f = S, !t && S || (S = "error", t < 0 && (t = 0))), x.status = t, x.statusText = (n || S) + "", c ? g.resolveWith(h, [p, S, x]) : g.rejectWith(h, [x, S, f]), x.statusCode(T), T = void 0, d && b.trigger(c ? "ajaxSuccess" : "ajaxError", [x, m, c ? p : f]), w.fireWith(h, [x, S]), d && (b.trigger("ajaxComplete", [x, m]), --Se.active || Se.event.trigger("ajaxStop")))
                }

                "object" == typeof t && (n = t, t = void 0), n = n || {};
                var r, i, a, s, l, c, u, d, p, f, m = Se.ajaxSetup({}, n), h = m.context || m,
                    b = m.context && (h.nodeType || h.jquery) ? Se(h) : Se.event, g = Se.Deferred(),
                    w = Se.Callbacks("once memory"), T = m.statusCode || {}, y = {}, v = {}, S = "canceled", x = {
                        readyState: 0, getResponseHeader: function (e) {
                            var t;
                            if (u) {
                                if (!s) for (s = {}; t = Vt.exec(a);) s[t[1].toLowerCase()] = t[2];
                                t = s[e.toLowerCase()]
                            }
                            ...
                            var t;
                            if (e) if (u) x.always(e[x.status]); else for (t in e) T[t] = [T[t], e[t]];
                            return this
                        }, abort: function (e) {
                            var t = e || S;
                ...
                if (g.promise(x), m.url = ((t || m.url || Gt.href) + "").replace(jt, Gt.protocol + "//"), m.type = n.method || n.type || m.method || m.type, m.dataTypes = (m.dataType || "*").toLowerCase().match(De) || [""], null == m.crossDomain) {
                ...
                d = Se.event && m.global, d && 0 == Se.active++ && Se.event.trigger("ajaxStart"), m.type = m.type.toUpperCase(), m.hasContent = !Xt.test(m.type), i = m.url.replace(Nt, ""), m.hasContent ? m.data && m.processData && 0 === (m.contentType || "").indexOf("application/x-www-form-urlencoded") && (m.data = m.data.replace(Ot, "+")) : (f = m.url.slice(i.length), m.data && (m.processData || "string" == typeof m.data) && (i += (Et.test(i) ? "&" : "?") + m.data, delete m.data), !1 === m.cache && (i = i.replace(Rt, "$1"), f = (Et.test(i) ? "&" : "?") + "_=" + Bt++ + f), m.url = i + f), m.ifModified && (Se.lastModified[i] && x.setRequestHeader("If-Modified-Since", Se.lastModified[i]), Se.etag[i] && x.setRequestHeader("If-None-Match", Se.etag[i])), (m.data && m.hasContent && !1 !== m.contentType || n.contentType) && x.setRequestHeader("Content-Type", m.contentType), x.setRequestHeader("Accept", m.dataTypes[0] && m.accepts[m.dataTypes[0]] ? m.accepts[m.dataTypes[0]] + ("*" !== m.dataTypes[0] ? ", " + zt + "; q=0.01" : "") : m.accepts["*"]);
            ...
            Se[t] = function (e, n, o, r) {
                return Te(n) && (r = r || o, o = n, n = void 0), Se.ajax(Se.extend({
                    url: e,
                    type: t,
                    dataType: r,
                    data: n,
        ...
        var Ut = {0: 200, 1223: 204}, Kt = Se.ajaxSettings.xhr();
        we.cors = !!Kt && "withCredentials" in Kt, we.ajax = Kt = !!Kt, Se.ajaxTransport(function (t) {
            var n, o;
            if (we.cors || Kt && !t.crossDomain) return {
                send: function (r, i) {
                    var a, s = t.xhr();
        ...
        Se.ajaxSetup({
            ...
            if (s || "jsonp" === t.dataTypes[0]) return r = t.jsonpCallback = Te(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, s ? t[s] = t[s].replace($t, "$1" + r) : !1 !== t.jsonp && (t.url += (Et.test(t.url) ? "&" : "?") + t.jsonp + "=" + r), t.converters["script json"] = function () {
            ...
            var o, r, i;
            return t || (we.createHTMLDocument ? (t = se.implementation.createHTMLDocument(""), o = t.createElement("base"), o.href = se.location.href, t.head.appendChild(o)) : t = se), r = ke.exec(e), i = !n && [], r ? [t.createElement(r[1])] : (r = A([e], t, i), i && i.length && Se(i).remove(), Se.merge([], r.childNodes))
        }, Se.fn.load = function (e, t, n) {
            var o, r, i, a = this, s = e.indexOf(" ");
            return s > -1 && (o = Y(e.slice(s)), e = e.slice(0, s)), Te(t) ? (n = t, t = void 0) : t && "object" == typeof t && (r = "POST"), a.length > 0 && Se.ajax({
                url: e,
                type: r || "GET",
                dataType: "html",
                data: t
            ...
            setOffset: function (e, t, n) {
                var o, r, i, a, s, l, c, u = Se.css(e, "position"), d = Se(e), p = {};
                "static" === u && (e.style.position = "relative"), s = d.offset(), i = Se.css(e, "top"), l = Se.css(e, "left"), c = ("absolute" === u || "fixed" === u) && (i + l).indexOf("auto") > -1, c ? (o = d.position(), a = o.top, r = o.left) : (a = parseFloat(i) || 0, r = parseFloat(l) || 0), Te(t) && (t = t.call(e, n, Se.extend({}, s))), null != t.top && (p.top = t.top - s.top + a), null != t.left && (p.left = t.left - s.left + r), "using" in t ? t.using.call(e, p) : d.css(p)
            }
        }, Se.fn.extend({
            offset: function (e) {
                ...
                if (this[0]) {
                    ...
                    if ("fixed" === Se.css(o, "position")) t = o.getBoundingClientRect(); else {
                    ...
                    return {
                        top: t.top - r.top - Se.css(o, "marginTop", !0),
                        left: t.left - r.left - Se.css(o, "marginLeft", !0)
                    }
                }
            ...
            Se.each({padding: "inner" + e, content: t, "": "outer" + e}, function (n, o) {
                Se.fn[o] = function (r, i) {
                    ...
                    return Oe(this, function (t, n, r) {
                        var i;
                        return ye(t) ? 0 === o.indexOf("outer") ? t["inner" + e] : t.document.documentElement["client" + e] : 9 === t.nodeType ? (i = t.documentElement, Math.max(t.body["scroll" + e], i["scroll" + e], t.body["offset" + e], i["offset" + e], i["client" + e])) : void 0 === r ? Se.css(t, n, s) : Se.style(t, n, r, s)
                    }, t, a ? r : void 0, a)
                }
            })
            ...
            var n, o, r;
            if ("string" == typeof t && (n = e[t], t = e, e = n), Te(e)) return o = ce.call(arguments, 2), r = function () {
                return e.apply(t || this, o.concat(ce.call(arguments)))
            }, r.guid = e.guid = e.guid || Se.guid++, r
        }, Se.holdReady = function (e) {
            e ? Se.readyWait++ : Se.ready(!0)
        }, Se.isArray = Array.isArray, Se.parseJSON = JSON.parse, Se.nodeName = a, Se.isFunction = Te, Se.isWindow = ye, Se.camelCase = h, Se.type = r, Se.now = Date.now, Se.isNumeric = function (e) {
            var t = Se.type(e);
        ...
        function n() {
            ...
            -1 !== this.opts.closeMethods.indexOf("button") && this.modal.appendChild(this.modalCloseBtn), this.modal.appendChild(this.modalBox)
        }
        ...
        function r() {
            this._events = {
                ...
                clickOverlay: a.bind(this),
                resize: this.checkOverflow.bind(this),
                keyboardNav: i.bind(this)
        ...
        return e.prototype.init = function () {
            ...
            if (!this._isBusy()) {
                ...
                var t = this;
                e ? (t.modal.style.display = "none", "function" == typeof t.opts.onClose && t.opts.onClose.call(this), t._busy(!1)) : u ? this.modal.addEventListener(u, function e() {
                ...
                }, !1) : (t.modal.style.display = "none", "function" == typeof t.opts.onClose && t.opts.onClose.call(this), t._busy(!1))
            }
            ...
            return o.innerHTML = e, o.addEventListener("click", n), "string" == typeof t && t.length && t.split(" ").forEach(function (e) {
                o.classList.add(e)
        ...
        e("mobiledetect", [], function () {
            ...
            return i.FALLBACK_PHONE = "UnknownPhone", i.FALLBACK_TABLET = "UnknownTablet", i.FALLBACK_MOBILE = "UnknownMobile", a = "isArray" in Array ? Array.isArray : function (e) {
                return "[object Array]" === Object.prototype.toString.call(e)
            }, function () {
                var e, t, o, r, l, c, u = i.mobileDetectRules;
                for (e in u.props) if (s.call(u.props, e)) {
                    for (t = u.props[e], a(t) || (t = [t]), l = t.length, r = 0; r < l; ++r) o = t[r], c = o.indexOf("[VER]"), c >= 0 && (o = o.substring(0, c) + "([\\w._\\+]+)" + o.substring(c + 5)), t[r] = new RegExp(o, "i");
                    u.props[e] = t
                }
                ...
                var n, o, r, a, l = i.mobileDetectRules.props;
                ...
                if (void 0 === e.mobile) {
                    ...
                    i.isMobileFallback(t) ? (s = r.isPhoneSized(n), void 0 === s ? (e.mobile = i.FALLBACK_MOBILE, e.tablet = e.phone = null) : s ? (e.mobile = e.phone = i.FALLBACK_PHONE, e.tablet = null) : (e.mobile = e.tablet = i.FALLBACK_TABLET, e.phone = null)) : i.isTabletFallback(t) ? (e.mobile = e.tablet = i.FALLBACK_TABLET, e.phone = null) : e.mobile = e.tablet = e.phone = null
                }
            ...
            }, r._impl = i, r.version = "1.4.3 2018-09-08", r
        })
    }(function (e) {
        ...
        function c() {
            var e = ge.innerParams.get(this), t = ge.domCache.get(this);
            e.showConfirmButton || (H(t.confirmButton), e.showCancelButton || H(t.actions)), G([t.popup, t.actions], S.loading), t.popup.removeAttribute("aria-busy"), t.popup.removeAttribute("data-loading"), t.confirmButton.disabled = !1, t.cancelButton.disabled = !1
        }

        function u(e) {
            var t = L(), n = O(), o = ge.innerParams.get(this), r = ve.swalPromiseResolve.get(this), i = o.onClose,
                a = o.onAfterClose;
            if (n) {
                null !== i && "function" == typeof i && i(n), G(n, S.show), k(n, S.hide);
                var s = function () {
                    $() ? Se(a) : (new Promise(function (e) {
        ...
        function d() {
            if ("undefined" != typeof window) {
                "undefined" == typeof Promise && b("This package requires a Promise library, please include a shim to enable it in this browser (See: https://github.com/sweetalert2/sweetalert2/wiki/Migration-from-SweetAlert-to-SweetAlert2#1-ie-support)"), p = this;
        ...
        var p, f = "SweetAlert2:", m = function (e) {
            ...
            S = v(["container", "shown", "height-auto", "iosfix", "popup", "modal", "no-backdrop", "toast", "toast-shown", "toast-column", "fade", "show", "hide", "noanimation", "close", "title", "header", "content", "actions", "confirm", "cancel", "footer", "icon", "icon-text", "image", "input", "file", "range", "select", "radio", "checkbox", "label", "textarea", "inputerror", "validation-message", "progress-steps", "active-progress-step", "progress-step", "progress-step-line", "loading", "styled", "top", "top-start", "top-end", "top-left", "top-right", "center", "center-start", "center-end", "center-left", "center-right", "bottom", "bottom-start", "bottom-end", "bottom-left", "bottom-right", "grow-row", "grow-column", "grow-fullscreen", "rtl"]),
            x = v(["success", "warning", "info", "question", "error"]), A = {previousBodyPadding: null},
            P = function (e, t) {
                ...
                var e = m(O().querySelectorAll('[tabindex]:not([tabindex="-1"]):not([tabindex="0"])')).sort(function (e, t) {
                    ...
                    t = m(O().querySelectorAll('a[href], area[href], input:not([disabled]), select:not([disabled]), textarea:not([disabled]), button:not([disabled]), iframe, object, embed, [tabindex="0"], [contenteditable], audio[controls], video[controls]')).filter(function (e) {
            ...
            J = function (e) {
                ...
                if (t && (t.parentNode.removeChild(t), G([document.documentElement, document.body], [S["no-backdrop"], S["toast-shown"], S["has-column"]])), !Y()) {
                    ...
                    o.appendChild(n);
                    var r, i = O(), a = V(), s = B(a, S.input), l = B(a, S.file),
                        c = a.querySelector(".".concat(S.range, " input")),
                        u = a.querySelector(".".concat(S.range, " output")), d = B(a, S.select),
                        p = a.querySelector(".".concat(S.checkbox, " input")), f = B(a, S.textarea);
                    i.setAttribute("role", e.toast ? "alert" : "dialog"), i.setAttribute("aria-live", e.toast ? "polite" : "assertive"), e.toast || i.setAttribute("aria-modal", "true"), "rtl" === window.getComputedStyle(o).direction && k(L(), S.rtl);
                    var m = function (e) {
                        Ce.isVisible() && r !== e.target.value && Ce.resetValidationMessage(), r = e.target.value
                    };
                    return s.oninput = m, l.onchange = m, d.onchange = m, p.onchange = m, f.oninput = m, c.oninput = function (e) {
                        m(e), u.value = c.value
                ...
                if (!t) return H(n);
                if (t instanceof HTMLElement) n.appendChild(t); else if ("object" === e(t)) if (n.innerHTML = "", 0 in t) for (var o = 0; o in t; o++) n.appendChild(t[o].cloneNode(!0)); else n.appendChild(t.cloneNode(!0)); else t && (n.innerHTML = t);
                E(n)
            }, te = function () {
                if (Y()) return !1;
                ...
                if (e.type) if (-1 !== Object.keys(x).indexOf(e.type)) {
                ...
                var t = F();
                e.imageUrl ? (t.setAttribute("src", e.imageUrl), t.setAttribute("alt", e.imageAlt), E(t), e.imageWidth ? t.setAttribute("width", e.imageWidth) : t.removeAttribute("width"), e.imageHeight ? t.setAttribute("height", e.imageHeight) : t.removeAttribute("height"), t.className = S.image, e.imageClass && k(t, e.imageClass)) : H(t)
            }, ae = function (e) {
                var t = X(), n = parseInt(null === e.currentProgressStep ? Ce.getQueueStep() : e.currentProgressStep, 10);
                e.progressSteps && e.progressSteps.length ? (E(t), t.innerHTML = "", n >= e.progressSteps.length && h("Invalid currentProgressStep parameter, it should be less than progressSteps.length (currentProgressStep like JS arrays starts from 0)"), e.progressSteps.forEach(function (o, r) {
            ...
            me = function (e) {
                ...
                queue: function (e) {
                    ...
                    return new Promise(function (e) {
                        !function r(i, a) {
                            i < le.length ? (document.body.setAttribute("data-swal2-queue-step", i), t.fire(le[i]).then(function (t) {
            ...
            }), ge = {promise: new WeakMap, innerParams: new WeakMap, domCache: new WeakMap}, we = function () {
                null === A.previousBodyPadding && document.body.scrollHeight > window.innerHeight && (A.previousBodyPadding = parseInt(window.getComputedStyle(document.body).getPropertyValue("padding-right")), document.body.style.paddingRight = A.previousBodyPadding + function () {
                ...
                var t = L(), n = O();
                null !== e.onBeforeOpen && "function" == typeof e.onBeforeOpen && e.onBeforeOpen(n), e.animation ? (k(n, S.show), k(t, S.fade), G(n, S.hide)) : G(n, S.fade), E(n), t.style.overflowY = "hidden", te && !P(n, S.noanimation) ? n.addEventListener(te, function e() {
                    n.removeEventListener(te, e), t.style.overflowY = "auto"
                }) : t.style.overflowY = "auto", k([document.documentElement, document.body, t], S.shown), e.heightAuto && e.backdrop && !e.toast && k([document.documentElement, document.body], S["height-auto"]), Q() && (e.scrollbarPadding && we(), function () {
                ...
                }(), "undefined" != typeof window && Te() && (ye(), window.addEventListener("resize", ye)), m(document.body.children).forEach(function (e) {
                    e === L() || function (e, t) {
                        if ("function" == typeof e.contains) return e.contains(t)
                    }(e, L()) || (e.hasAttribute("aria-hidden") && e.setAttribute("data-previous-aria-hidden", e.getAttribute("aria-hidden")), e.setAttribute("aria-hidden", "true"))
                }), setTimeout(function () {
                    t.scrollTop = 0
                })), $() || ue.previousActiveElement || (ue.previousActiveElement = document.activeElement), null !== e.onOpen && "function" == typeof e.onOpen && setTimeout(function () {
                    e.onOpen(n)
                })
            }, Me = Object.freeze({
                hideLoading: c, disableLoading: c, getInput: function (e) {
                    var t = ge.innerParams.get(this), n = ge.domCache.get(this);
                ...
                }, close: u, closePopup: u, closeModal: u, closeToast: u, enableButtons: function () {
                    ...
                    var n = this;
                    !function (e) {
                        for (var t in e) me(t) || h('Unknown parameter "'.concat(t, '"')), e.toast && -1 !== fe.indexOf(t) && h('The parameter "'.concat(t, '" is incompatible with toasts')), he(t) && (n = 'The parameter "'.concat(t, '" is deprecated and will be removed in the next major release.'), -1 === g.indexOf(n) && (g.push(n), h(n)));
                        var n
                    }(t);
                    var r = o({}, de, t);
                    !function (e) {
                        ...
                        }), (!e.target || "string" == typeof e.target && !document.querySelector(e.target) || "string" != typeof e.target && !e.target.appendChild) && (h('Target parameter is not valid, defaulting to "body"'), e.target = "body"), "function" == typeof e.animation && (e.animation = e.animation.call());
                        var n = O(), o = "string" == typeof e.target ? document.querySelector(e.target) : e.target;
                        t = n && o && n.parentNode !== o.parentNode ? J(e) : n || J(e), e.width && (t.style.width = "number" == typeof e.width ? e.width + "px" : e.width), e.padding && (t.style.padding = "number" == typeof e.padding ? e.padding + "px" : e.padding), e.background && (t.style.background = e.background);
                    ...
                    return new Promise(function (t) {
                        ...
                        ve.swalPromiseResolve.set(n, t), r.timer && (ue.timeout = new xe(function () {
                        ...
                        for (var l = function (e) {
                            r.showLoaderOnConfirm && a.showLoading(), r.preConfirm ? (n.resetValidationMessage(), Promise.resolve().then(function () {
                                return r.preConfirm(e, r.validationMessage)
                            }).then(function (t) {
                                D(i.validationMessage) || !1 === t ? n.hideLoading() : o(void 0 === t ? e : t)
                            })) : o(e)
                        }, c = function (e) {
                            var t = e.target, o = i.confirmButton, c = i.cancelButton, u = o && (o === t || o.contains(t)),
                                d = c && (c === t || c.contains(t));
                            switch (e.type) {
                                case"click":
                                    if (u && a.isVisible()) if (n.disableButtons(), r.input) {
                                        var p = function () {
                                            var e = n.getInput();
                                            if (!e) return null;
                                            switch (r.input) {
                                        ...
                                        r.inputValidator ? (n.disableInput(), Promise.resolve().then(function () {
                                            return r.inputValidator(p, r.validationMessage)
                                        }).then(function (e) {
                                            n.enableButtons(), n.enableInput(), e ? n.showValidationMessage(e) : l(p)
                                        })) : n.getInput().checkValidity() ? l(p) : (n.enableButtons(), n.showValidationMessage(r.validationMessage))
                                    } else l(!0); else d && a.isVisible() && (n.disableButtons(), s(a.DismissReason.cancel))
                            }
                        }, u = i.popup.querySelectorAll("button"), d = 0; d < u.length; d++) u[d].onclick = c, u[d].onmouseover = c, u[d].onmouseout = c, u[d].onmousedown = c;
                        if (i.closeButton.onclick = function () {
                            s(a.DismissReason.close)
                        }, r.toast) i.popup.onclick = function () {
                        ...
                        ue.keydownHandlerAdded && (ue.keydownTarget.removeEventListener("keydown", ue.keydownHandler, {capture: ue.keydownListenerCapture}), ue.keydownHandlerAdded = !1), r.toast || (ue.keydownHandler = function (e) {
                            return function (e, t) {
                                if (t.stopKeydownPropagation && e.stopPropagation(), "Enter" !== e.key || e.isComposing) if ("Tab" === e.key) {
                                    for (var o = e.target, r = K(t.focusCancel), l = -1, c = 0; c < r.length; c++) if (o === r[c]) {
                                        l = c;
                                        break
                                    }
                                    e.shiftKey ? f(l, -1) : f(l, 1), e.stopPropagation(), e.preventDefault()
                                } else -1 !== ["ArrowLeft", "ArrowRight", "ArrowUp", "ArrowDown", "Left", "Right", "Up", "Down"].indexOf(e.key) ? document.activeElement === i.confirmButton && D(i.cancelButton) ? i.cancelButton.focus() : document.activeElement === i.cancelButton && D(i.confirmButton) && i.confirmButton.focus() : "Escape" !== e.key && "Esc" !== e.key || !0 !== w(t.allowEscapeKey) || (e.preventDefault(), s(a.DismissReason.esc)); else if (e.target && n.getInput() && e.target.outerHTML === n.getInput().outerHTML) {
                                    if (-1 !== ["textarea", "file"].indexOf(t.input)) return;
                                    a.clickConfirm(), e.preventDefault()
                                }
                            }(e, r)
                        }, ue.keydownTarget = r.keydownListenerCapture ? window : i.popup, ue.keydownListenerCapture = r.keydownListenerCapture, ue.keydownTarget.addEventListener("keydown", ue.keydownHandler, {capture: ue.keydownListenerCapture}), ue.keydownHandlerAdded = !0), n.enableButtons(), n.hideLoading(), n.resetValidationMessage(), r.toast && (r.input || r.footer || r.showCloseButton) ? k(document.body, S["toast-column"]) : G(document.body, S["toast-column"]);
                        for (var m, g, y = ["input", "file", "range", "select", "radio", "checkbox", "textarea"], v = function (e) {
                            e.placeholder && !r.inputPlaceholder || (e.placeholder = r.inputPlaceholder)
                        }, x = 0; x < y.length; x++) {
                            var A = S[y[x]], P = B(i.content, A);
                            if (m = n.getInput(y[x])) {
                                for (var C in m.attributes) if (m.attributes.hasOwnProperty(C)) {
                        ...
                        switch (r.input) {
                            ...
                            case"tel":
                            case"url":
                                m = B(i.content, S.input), "string" == typeof r.inputValue || "number" == typeof r.inputValue ? m.value = r.inputValue : T(r.inputValue) || h('Unexpected type of inputValue! Expected "string", "number" or "Promise", got "'.concat(e(r.inputValue), '"')), v(m), m.type = r.input, E(m);
                                break;
                            case"file":
                                v(m = B(i.content, S.file)), m.type = r.input, E(m);
                                break;
                            case"range":
                                var O = B(i.content, S.range), N = O.querySelector("input"), R = O.querySelector("output");
                            ...
                            case"radio":
                                ...
                                break;
                            case"checkbox":
                                var j = B(i.content, S.checkbox), _ = n.getInput("checkbox");
                        ...
                        if ("select" === r.input || "radio" === r.input) {
                            var z = function (e) {
                                return g((t = e, n = [], "undefined" != typeof Map && t instanceof Map ? t.forEach(function (e, t) {
                                    n.push([t, e])
                            ...
                            T(r.inputOptions) ? (a.showLoading(), r.inputOptions.then(function (e) {
                                n.hideLoading(), z(e)
                            })) : "object" === e(r.inputOptions) ? z(r.inputOptions) : b("Unexpected type of inputOptions! Expected object, Map or Promise, got ".concat(e(r.inputOptions)))
                        } else -1 !== ["text", "email", "number", "tel", "textarea"].indexOf(r.input) && T(r.inputValue) && (a.showLoading(), H(m), r.inputValue.then(function (e) {
                        ...
                        Pe(r), r.toast || (w(r.allowEnterKey) ? r.focusCancel && D(i.cancelButton) ? i.cancelButton.focus() : r.focusConfirm && D(i.confirmButton) ? i.confirmButton.focus() : f(-1, 1) : document.activeElement && "function" == typeof document.activeElement.blur && document.activeElement.blur()), i.container.scrollTop = 0
                    })
                }, update: function (e) {
                    var t = {};
        ...
        }, o(d.prototype, Me), o(d, be), Object.keys(Me).forEach(function (e) {
            d[e] = function () {
                var t;
                if (p) return (t = p)[e].apply(t, arguments)
            }
        }), d.DismissReason = y, d.version = "8.2.1";
        var Ce = d;
        return Ce.default = Ce
    }), "undefined" != typeof window && window.Sweetalert2 && (window.swal = window.sweetAlert = window.Swal = window.SweetAlert = window.Sweetalert2), "undefined" != typeof document && function (e, t) {
        ...
        !function (e) {
            r.fn.attr = function () {
                if (0 === arguments.length) {
                    ...
                    var t = {};
                    return r.each(this[0].attributes, function () {
                        this.specified && (t[this.name] = this.value)
                    }), t
                }
                return e.apply(this, arguments)
            }
        }(r.fn.attr), r(function () {
            function e(e) {
                if (void 0 != e.data) {
                    var t = {};
                    try {
                    ...
                    void 0 != t.status && "success" == t.status && (void 0 != t.url && -1 !== t.url.indexOf("http") && (window.location.href = t.url), void 0 != t.type && ("redirect" != t.type && "gw_redirect" != t.type || (window.location.href = t.url)), void 0 != t.type && "otp" == t.type && (window.location.href = t.url), void 0 != t.type && ("resize" == t.type && void 0 != t.height && t.height > 100 && (f ? c.style.minHeight = window.outerHeight - 100 + "px" : c.height = t.height), console.log(t.type)))
                }
                console.log(t)
            }
            ...
            function i() {
                ...
                var postData = document.getElementById('sslczPayBtn').getAttribute('postdata');
                var t = postData ? JSON.parse(postData) : {};
                var n = document.getElementById('sslczPayBtn').getAttribute('token');
                ...
                r.ajax({
                    ...
                    if (e.status !== undefined) {
                        if (e.status === "success") {
                            ...
                            } else if (e.GatewayPageURL && e.GatewayPageURL.indexOf("http") !== -1) {
                                setTimeout(function () {
                    ...
                    o.fire({
                        ...
                        text: "Oops! Something wrong, Try again" + JSON.stringify(e),
                        type: "error",
            ...
            function l(e, n) {
                if (console.log("jh"), null !== f) a(), window.open(e, "_blank"); else {
                    console.log("isMobile" + f), u = new t.modal({
                        footer: !0,
                        stickyFooter: !1,
                        closeMethods: ["button"],
                        closeLabel: "Close",
                    ...
                    }), e += "?full=1", console.log("is url" + e);
                    var o = document.createElement("div"), r = document.createElement("div"),
                        i = document.createElement("div");
                    r.className = "client_logo", i.className = "client_logo_inner";
                    var s = document.createElement("div");
                    s.setAttribute("class", "iframeWrap"), c = document.createElement("iframe"), c.src = e, c.name = "frame", c.width = 340, c.setAttribute("frameborder", "0"), c.scrolling = "no", c.allowtransparency = !0, c.seamless = !0, c.height = 2e3, s.appendChild(c);
                    var l = document.createElement("img");
                    l.setAttribute("src", n), l.setAttribute("alt", "Logo"), i.appendChild(l), r.appendChild(i), o.appendChild(r), o.appendChild(s), u.setContent(o), u.addFooterBtn("&times;", "tingle-modal__close", function () {
                        u.close()
                    }), u.open()
                }
            }
            ...
            var d = !0;
            console.log("test data"), window.onfocus = function () {
                g = r("#sslczPayBtn"), d = !0
            ...
            r(".shaz_back_overlay")
            ;r(m).html('<div class="lock-center"><div class="icon-lock" style="clear: left; float: left"><div class="lock-top-1" style="background-color: #fff"></div><div class="lock-top-2"></div><div class="lock-body" style="background-color: #24c875"></div><div class="lock-hole"></div></div></div>'), m.append(h), r("body").append(m);
            var b = r("#myForm"), g = r("#sslczPayBtn"), w = b.attr(), T = g.attr();
            if (console.log("BUTTON VALUES", JSON.stringify(T)), null != T) {
                if (void 0 == T.order || "" == T.order) return void o.fire({
                    title: "Order Required",
                    text: "Order required to pay",
                    type: "error",
                    confirmButtonText: "Oh! Ok"
                });
                if (void 0 == T.endpoint || "" == T.endpoint) return void o.fire({
                    title: "Endpoint Required",
                    text: "Endpoint url required to pay",
                    type: "error",
                    confirmButtonText: "Oh! Ok"
                })
            }
            console.log(w), !window.XMLHttpRequest && "ActiveXObject" in window && (window.XMLHttpRequest = function () {
                ...
                r(".shaz_back_overlay");
                r(a).html('<div class="lock-center"><div class="icon-lock" style="clear: left; float: left"><div class="lock-top-1" style="background-color: #fff"></div><div class="lock-top-2"></div><div class="lock-body" style="background-color: #24c875"></div><div class="lock-hole"></div></div></div>'), a.append(s), r("body").append(a);
                var l = r("#myForm"), c = r("#sslczPayBtn");
                l.attr(), c.attr();
                i()
            })
        })
